local function custom_monokai()
    ...
    vim.api.nvim_set_hl(0, "VertSplit", { fg = bg, bg = bg })
    ...
    vim.api.nvim_set_hl(0, "TreesitterContextSeparator", { fg = bg })
    ...
    vim.api.nvim_set_hl(0, "SnacksWinSeparator", { fg = bg, bg = bg })
    vim.api.nvim_set_hl(0, "SnacksExplorerWinSeparator", { fg = bg, bg = bg })
